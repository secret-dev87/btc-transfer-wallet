            ...
            <div className="ui three column stackable grid ">
              <div className="column">
                <div className="card">
                  ...
                  <p style={{ color: '#FF9A00' }}>
                    Bitcoin is characterized by its decentralized nature,
                    setting it apart from traditional fiat currencies which are
                    controlled and regulated by central authorities. Unlike fiat
                    currencies, bitcoins are not issued by governmental
              ...
              <div className="column">
                <div className="card">
                  ...
                  <p style={{ color: '#FF9A00' }}>
                    Bitcoin is utilized globally for sending money, making
                    online purchases, and anonymous transactions due to its
                    ease, speed, low fees, and untraceability.
                  </p>
                </div>
              </div>
              <div className="column">
                <div className="card">
                  ...
                  <p style={{ color: '#FF9A00' }}>
                    Bitcoin transactions are protected by cryptography, which
                    hides the identities of the sender and receiver, making them
                    pseudonymous.
                  </p>
                </div>
              </div>
